...
router.get('/customers/logout', authenticateUser, authorizeCustomer, usersControllers.logout)
...
router.get('/service-providers/logout', authenticateUser, authorizeServiceProvider, usersControllers.logout)
